    ...
    <div class="card-body">
        <div class="border p-4 rounded">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-success">EDIT USER</h5>
            ...
            <?php } ?>
            <form class="form-horizontal" action="/user/update/<?= $user['user_id'] ?>" method="post" autocomplete="off">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <label class="col-sm-2 control-label" style="text-align:right">Full Name</label>
                    <div class="col-sm-3">
                        <input type="text" name="full_name" id="full_name" class="form-control<?= ($validation->hasError('full_name')) ? ' is-invalid' : ''; ?>" value="<?= $user['full_name']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="birth_place" id="birth_place" class="form-control<?= ($validation->hasError('birth_place')) ? ' is-invalid' : ''; ?>" value="<?= $user['birth_place']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="date" name="birth_date" id="birth_date" class="form-control<?= ($validation->hasError('birth_date')) ? ' is-invalid' : ''; ?>" value="<?= $user['birth_date']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <select id="gender" name="gender" class="form-control<?= ($validation->hasError('gender')) ? ' is-invalid' : ''; ?>" value="<?= $user['gender']; ?>">
                            <option value="2" <?= ($user['gender'] == "2") ? ' selected' : '' ?>>Woman</option>
                            <option value="1" <?= ($user['gender'] == "1") ? ' selected' : '' ?>>Man</option>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <textarea name="address" id="address" class="form-control<?= ($validation->hasError('address')) ? ' is-invalid' : ''; ?>"><?= $user['address']; ?></textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <select class="single-select" id="province_id" name="province_id" class="form-control<?= ($validation->hasError('province_id')) ? ' is-invalid' : ''; ?>" value="<?= $user['province_id']; ?>">
                            <?= $province; ?>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <select class="single-select" id="district_id" name="district_id" class="form-control<?= ($validation->hasError('district_id')) ? ' is-invalid' : ''; ?>" value="<?= $user['district_id']; ?>">
                            <?= $district; ?>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <select class="single-select" id="subdistrict_id" name="subdistrict_id" class="form-control<?= ($validation->hasError('subdistrict_id')) ? ' is-invalid' : ''; ?>" value="<?= $user['subdistrict_id']; ?>">
                            <?= $district; ?>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <select class="single-select" id="village_id" name="village_id" class="form-control<?= ($validation->hasError('village_id')) ? ' is-invalid' : ''; ?>" value="<?= $user['village_id']; ?>">
                            <?= $district; ?>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="email" name="email" id="email" class="form-control<?= ($validation->hasError('email')) ? ' is-invalid' : ''; ?>" value="<?= $user['email']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="mobile_phone" id="mobile_phone" class="form-control<?= ($validation->hasError('mobile_phone')) ? ' is-invalid' : ''; ?>" value="<?= $user['mobile_phone']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="phone" id="phone" class="form-control<?= ($validation->hasError('phone')) ? ' is-invalid' : ''; ?>" value="<?= $user['phone']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <select class="single-select" id="user_type_id" name="user_type_id" class="form-control<?= ($validation->hasError('user_type_id')) ? ' is-invalid' : ''; ?>" value="<?= $user['user_type_id']; ?>">
                            <?= $user_type; ?>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="idcard_number" id="idcard_number" class="form-control<?= ($validation->hasError('idcard_number')) ? ' is-invalid' : ''; ?>" value="<?= $user['idcard_number']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="doc_idcard_path" id="doc_idcard_path" class="form-control<?= ($validation->hasError('doc_idcard_path')) ? ' is-invalid' : ''; ?>" value="<?= $user['doc_idcard_path']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="user_name" id="user_name" class="form-control<?= ($validation->hasError('user_name')) ? ' is-invalid' : ''; ?>" value="<?= $user['user_name']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="password" name="user_password" id="user_password" class="form-control<?= ($validation->hasError('user_password')) ? ' is-invalid' : ''; ?>" value="">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="password" name="confirm_password" id="confirm_password" class="form-control<?= ($validation->hasError('confirm_password')) ? ' is-invalid' : ''; ?>" value="">
