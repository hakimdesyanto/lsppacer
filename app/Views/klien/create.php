...
<h6 class="mb-0 text-uppercase">Tambah Klien</h6>
<hr />
...
<div class="card">
    <div class="card-body">
        <div class="panel-body">
            ...
            <?php } ?>
            <form class="form-horizontal" action="/klien/insert" method="post" autocomplete="off">
                <?= csrf_field(); ?>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Nama Klien</label>
                    <div class="col-sm-3">
                        <input type="text" name="gklien" id="gklien" class="form-control<?= ($validation->hasError('gklien')) ? ' is-invalid' : ''; ?>" value="<?= old('gklien'); ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <textarea name="galamat" id="galamat" class="form-control<?= ($validation->hasError('galamat')) ? ' is-invalid' : ''; ?>"><?= old('galamat'); ?></textarea>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="gtelp" id="gtelp" class="form-control<?= ($validation->hasError('gtelp')) ? ' is-invalid' : ''; ?>" value="<?= old('gtelp'); ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="gfax" id="gfax" class="form-control<?= ($validation->hasError('gfax')) ? ' is-invalid' : ''; ?>" value="<?= old('gfax'); ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="gmail" id="gmail" class="form-control<?= ($validation->hasError('gmail')) ? ' is-invalid' : ''; ?>" value="<?= old('gmail'); ?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="guserlogin" id="guserlogin" class="form-control<?= ($validation->hasError('guserlogin')) ? ' is-invalid' : ''; ?>" value="<?= old('guserlogin'); ?>">
                    </div>
