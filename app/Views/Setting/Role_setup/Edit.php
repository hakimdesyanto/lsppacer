    ...
    <div class="card-body">
        <div class="border p-4 rounded">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-success">EDIT ROLE</h5>
            ...
            <?php } ?>
            <form class="form-horizontal" action="/RoleSetup/update/<?= $role_setup['role_id'] ?>" method="post" autocomplete="off">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <label class="col-sm-2 control-label" style="text-align:right">Role Name</label>
                    <div class="col-sm-3">
                        <input type="text" name="role_name" id="role_name" class="form-control<?= ($validation->hasError('role_name')) ? ' is-invalid' : ''; ?>" value="<?= $role_setup['role_name']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <textarea name="role_desc" id="role_desc" class="form-control<?= ($validation->hasError('role_desc')) ? ' is-invalid' : ''; ?>"> <?= $role_setup['role_desc']; ?></textarea>
