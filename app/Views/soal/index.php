...
<h6 class="mb-0 text-uppercase">Daftar Soal Test</h6>
<hr />
<a href="/soal/create" class="btn btn-success btn-sm mb-3">Tambah Soal Test</a>
<?php if ($pesan != '') { ?>
                    ...
                    ?>
                        <tr class="gradeX">
                            ...
                            <td style="text-align: center;">
                                <a class="btn btn-outline-success btn-sm" href="<?= base_url() ?>/soal/edit/<?= $value['soal_id']; ?>"><i class="bx bx-message-edit"></i> Edit</a>
                            </td>
                        </tr>
                    <?php
                        $num++;
