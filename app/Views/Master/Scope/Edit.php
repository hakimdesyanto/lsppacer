    ...
    <div class="card-body">
        <div class="border p-4 rounded">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-success">EDIT SCOPE</h5>
            ...
            <?php } ?>
            <form class="form-horizontal" action="/Scope/update/<?= $field_code['scope_id'] ?>" method="post" autocomplete="off">
                <?= csrf_field(); ?>

                <div class="row mb-3">
                    <label class="col-sm-2 control-label" style="text-align:right">Scope Code</label>
                    <div class="col-sm-3">
                        <input type="text" name="scope_code" id="scope_code" class="form-control<?= ($validation->hasError('scope_code')) ? ' is-invalid' : ''; ?>" value="<?= $field_code['scope_code']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <textarea type="text" name="scope_description" id="scope_description" class="form-control<?= ($validation->hasError('scope_description')) ? ' is-invalid' : ''; ?>"><?= $field_code['scope_description']; ?></textarea>
