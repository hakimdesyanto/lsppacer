    ...
    <div class="card-body">
        <div class="border p-4 rounded">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-success">EDIT CERTIFICATION TYPE</h5>
            ...
            <?php } ?>
            <form class="form-horizontal" action="/CertificationType/update/<?= $certification_type['certification_type_id'] ?>" method="post" autocomplete="off">
                <?= csrf_field(); ?>

                <div class="row mb-3">
                    <label class="col-sm-2 control-label" style="text-align:right">Description</label>
                    <div class="col-sm-3">
                        <input type="text" name="description" id="description" class="form-control<?= ($validation->hasError('description')) ? ' is-invalid' : ''; ?>" value="<?= $certification_type['description']; ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="cost" id="cost" class="form-control<?= ($validation->hasError('cost')) ? ' is-invalid' : ''; ?>" value="<?= $certification_type['cost']; ?>">
