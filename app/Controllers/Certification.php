...
class Certification extends BaseController
{
    ...
    public function insert()
    {
        if (!$this->validasi_data()) {
            ...
            $audit_experience_id = $this->CertificationModel->get_audit_experience_id();
    ...
    public function edit($id)
    {
        ...
        //$scope = $this->CertificationModel->get_certification_scope($certification['certification_id']);
        $scope = $this->BaseModel->getdatatoarray('certificationd_scope', 'scope_id', 'certification_id=' . $certification['certification_id']);
        //$field_code = $this->CertificationModel->get_certification_fieldcode($certification['certification_id']);
    ...
    public function update($id)
    {
        if (!$this->validasi_data()) {
            ...
            return redirect()->to('/Certification/edit/' . $id)->withInput();
        } else {
            ...
            $this->CertificationModel->update_certification($id, $data);

            /** insert into certificationd_scope */

            $this->CertificationModel->delete_certificationd_scope($id);
            // $this->db->query("Delete from certificationd_scope where certification_id=?", $id);
            ...
            /** insert into certificationd_fieldcode */
            $this->CertificationModel->delete_certificationd_fieldcode($id);
